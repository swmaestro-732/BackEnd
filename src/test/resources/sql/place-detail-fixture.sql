...
INSERT INTO place_reviews (place_id, user_id, rating, content, created_at)
VALUES (1, 1, 5, '팡도르가 정말 맛있어요.', now() - interval '3 days'),
       (1, 1, 4, '빵이 다양해요.', now() - interval '5 days'),
       (1, 1, 5, '조용해요.', now() - interval '10 days');
