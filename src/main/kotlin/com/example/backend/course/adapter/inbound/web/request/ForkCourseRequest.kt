...
/**
 * 코스 포크 요청(모킹 API) — 웹 어댑터 DTO. 노션 "코스 포크" 페이지가 본문 미작성이라
 ...
 * 교차 필드·비즈니스 규칙(발행 시 장소 2곳 이상·장소마다 사진 1장 이상, orderNo 중복 금지)은
 * 실구현 시 도메인([com.example.backend.course.domain.model.Course])이 검증한다(→ 400 INVALID_INPUT).
 *
