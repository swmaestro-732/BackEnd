 ...
 * 도메인 인바운드 포트 결과를 묶기만 한다 — 표시 로직(축약 라벨·장소명/카테고리 결합 등)은 web 계층 매퍼가 입힌다.
 *
