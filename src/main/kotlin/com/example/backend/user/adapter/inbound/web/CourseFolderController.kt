 ...
 *
 * - [create] 코스 저장 폴더 생성(`POST /service/v1/course-folders`): 노션 필드 명세 미작성 상태라
 *   디자인(저장 → 새 폴더 만들기 시트)에서 필드를 도출했다([CreateCourseFolderRequest]).
 * - [list] 코스 폴더 목록 조회(`GET /service/v1/course-folders`): 디자인(저장함 · 코스 탭 폴더 칩,
 ...
 *
 * 경로: `/service/v1/course-folders`.
 */
@RestController
@RequestMapping("/service/v1/course-folders")
@AccessTokenRequired
