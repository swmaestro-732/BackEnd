...
import com.example.backend.bff.adapter.inbound.web.response.AuthorResponse
import com.example.backend.bff.adapter.inbound.web.response.CourseDetailScreenResponse
import com.example.backend.bff.adapter.inbound.web.response.CoursePlaceImageResponse
import com.example.backend.bff.adapter.inbound.web.response.CoursePlaceScreenResponse
import com.example.backend.bff.adapter.inbound.web.response.CourseScreenResponse
import com.example.backend.bff.adapter.inbound.web.response.CourseStatsResponse
import com.example.backend.bff.adapter.inbound.web.response.CourseViewerResponse
import com.example.backend.bff.adapter.inbound.web.response.RatingCountResponse
import com.example.backend.bff.adapter.inbound.web.response.ReviewAuthorResponse
import com.example.backend.bff.adapter.inbound.web.response.ReviewPreviewResponse
